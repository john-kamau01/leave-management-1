         ...
         <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
               <ul class="nav navbar-nav">
                  ...
                  <li class="menu-item-has-children dropdown">
                     <a href="leave-type.php" > Leave Type Master</a>
                  </li>
				  <li class="menu-item-has-children dropdown">
				  ...
				  <?php } else { ?>
				  <li class="menu-item-has-children dropdown">
                     <a href="add-employee.php?id=<?php echo $_SESSION['USER_ID']?>" > Profile</a>
                  </li>
				  <?php } ?>
				   <li class="menu-item-has-children dropdown">
         ...
         <header id="header" class="header">
            <div class="top-left">
               <div class="navbar-header">
                  <a class="navbar-brand" href="index.php"><img src="images/netsmart-kenya-logo-1.jpg" alt="Logo"></a>
